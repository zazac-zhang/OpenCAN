...
impl OperationMode {
    ...
    /// Get the name of the operation mode.
    pub fn name(&self) -> &'static str {
        match self {
            ...
            Self::Homing => "Homing",
            Self::CyclicSyncPosition => "CyclicSyncPosition",
            Self::CyclicSyncVelocity => "CyclicSyncVelocity",
            Self::CyclicSyncTorque => "CyclicSyncTorque",
        }
    }
}
