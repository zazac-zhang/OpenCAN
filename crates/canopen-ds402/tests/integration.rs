...
async fn test_full_sdo_write_control_word() {
    ...
    client
        .download(5, 0x6040, 0, &OdValue::Unsigned16(0x000F))
        .await
        .unwrap();
...
mod ds402_tests {
    use super::*;
    use opencan_canopen_ds402::ds402::control::Ds402Device;
    use opencan_canopen_ds402::ds402::state_machine::{Ds402State, OperationMode};
