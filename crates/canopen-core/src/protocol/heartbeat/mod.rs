...
use crate::frame::{HeartbeatFrame, NmtState};
...
impl SyncProducer {
    ...
    pub fn build_frame(&mut self) -> crate::frame::CanOpenFrame {
        let mut data = [0u8; 8];
        ...
        self.last_sent = Some(Instant::now());
        crate::frame::CanOpenFrame::new(0x080, data)
    }
...
pub use crate::protocol::pdo::types::PdoDirection;
