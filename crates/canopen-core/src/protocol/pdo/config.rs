...
use crate::protocol::heartbeat::PdoDirection;
use crate::protocol::sdo::SdoClient;
use crate::CanDriver;
use crate::CanOpenError;
use crate::od::OdValue;
use super::types::{PdoMapping, pdo_comm_index, pdo_map_index};

// Re-export core PDO utilities for downstream consumers
pub use super::types::validate_mapping;
...
mod tests {
    ...
    async fn test_enable_pdo() {
        ...
        assert_eq!(tx.len(), 2);
        let sent_cob_id =
            u32::from_le_bytes([tx[1].data[4], tx[1].data[5], tx[1].data[6], tx[1].data[7]]);
